...
btn.onclick = function() {
    //判断日期是否为空
    tishiDate.style.display = "none";
    tishiName.style.display = "none";
    tishiSex.style.display = "none";
    tishiBuchong.style.display = "none";
    tishiPhone.style.display = "none";
    tishiYanzhen.style.display = "none";
    ...
    if (formphone.value == "") {
        ...
        tishi.style.display = "block";
    } else if (formphone.value.length != 11) {
        //判断电话号码是否为11位
        tishiPhone.style.display = "inline-block";
        tishiPhone.innerHTML = "请输入正确11位数字电话号码"
        tishi.style.display = "block";
    }
    //判断验证码是否为空
    if (formyanzhen.value == "") {
        ...
        tishi.style.display = "block";
    } else if (show_num.join("") != formyanzhen.value) {
        tishiYanzhen.style.display = "inline-block";
        tishi.style.display = "block";
        tishiYanzhen.innerHTML = "验证码输入错误，请重新输入"
    }
}
...
function draw(show_num) {
    ...
    var canvas = document.querySelector(".form-user-code"); //获取到canvas的对象
